...
export default function DupHero({
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        ".dhero-main-img",
        { opacity: 0, scale: 1.08, clipPath: "inset(10% 10% 10% 10% round 20px)" },
        {
          opacity: 1,
          scale: 1,
      ...
      gsap.fromTo(
        ".dhero-float",
        { opacity: 0, y: 40, x: -20 },
        { opacity: 1, y: 0, x: 0, duration: 0.9, ease: "power3.out", delay: 0.7 },
      );
      ...
      gsap.fromTo(
        ".dhero-accent",
        { opacity: 0, scale: 0 },
        { opacity: 1, scale: 1, duration: 0.6, stagger: 0.08, ease: "back.out(1.7)", delay: 0.9 },
      );
    }, heroRef);
  ...
  return (
    <section ref={heroRef} style={{ position: "relative", width: "100%", overflow: "hidden", backgroundColor: "#f9faf7" }}>
      ...
      <div style={{
        ...
        background: "radial-gradient(circle, rgba(103,149,80,0.08) 0%, transparent 70%)",
      ...
      <div className="max-margin" style={{ position: "relative", zIndex: 10 }}>
        ...
        <div className="hero-layout">
          ...
          <div style={{ flex: "1 1 0%", maxWidth: 560, minWidth: 0 }}>
            ...
            <h1 className="dhero-text font-grotesque" style={{
          ...
          <div className="hero-image-wrap" style={{ flex: "1 1 0%", position: "relative", maxWidth: 600, width: "100%" }}>

            {/* Main large image */}
            <div className="dhero-main-img" style={{
            ...
            <div className="dhero-float hidden sm:flex" style={{
              ...
              <div style={{
                ...
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#679550" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                </svg>
              </div>
              <div>
                <div style={{ fontSize: 13, fontWeight: 700, color: "#1a2e1a" }}>Verified</div>
                <div style={{ fontSize: 11, color: "#9CA3AF" }}>Premium Quality</div>
              </div>
            </div>

            {/* Decorative accent dots — desktop only */}
            <div className="dhero-accent hidden sm:grid" style={{
            ...
            <div className="dhero-accent hidden sm:block" style={{
